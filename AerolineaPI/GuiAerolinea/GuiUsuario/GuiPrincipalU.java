...
public class GuiPrincipalU extends JFrame {
	...
	public GuiPrincipalU() {
		...
		setTitle("Aerolinea UEB - Usuario-");
		setResizable(false);
	...
	public class OpcionesUsuario extends JPanel {
		...
		public OpcionesUsuario() {
			...
			// Instancias
			this.opcion1 = new JButton("Reservar Vuelo");
			this.opcion2 = new JButton("Comprar Tiquete");
			this.opcion3 = new JButton("Verificar Vuelo");
	...
	//Mensajes
	public class GuiMensajesUser extends JPanel {

		public JTextArea campoTexto;
		public JButton enviar2;
		private Font font;

		public GuiMensajesUser() {
